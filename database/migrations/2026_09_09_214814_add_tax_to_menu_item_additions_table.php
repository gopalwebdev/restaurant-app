...
return new class extends Migration
{
     ...
     *
     * Same shape and same meaning as menu_items.tax_rate_basis_points: basis
     * points cast to App\Enums\TaxRate, and null meaning "use the restaurant's
     * default". It is a column of its own rather than something inherited from
     * the dish because the two genuinely differ — a bottled drink added to a
     * meal is taxed as goods while the meal beside it is taxed as service, and
     * an invoice has to show each line at its own rate.
     *
