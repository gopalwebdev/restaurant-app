...
return [
    ...
    'categories' => [
        ...
        'section' => 'Category',
        'menu' => 'Menu',
        'menu_help' => 'Which menu this category appears on. Hiding a menu hides everything under it.',
        ...
        'delete_warning' => 'Every dish in this category is deleted with it. Hide it instead to take it off the menu and keep the dishes.',
        'move' => 'Move to another menu',
        'move_help' => 'The category keeps its dishes and its order; only the menu it sits on changes.',
