...
/**
 * Who may subdivide a restaurant's menu categories.
 *
...
class MenuSubCategoryPolicy
{
    ...
    public function view(User $user, MenuSubCategory $menuSubCategory): bool
    {
        return $user->can(Permission::MenuView->value);
    }
    ...
    public function update(User $user, MenuSubCategory $menuSubCategory): bool
    {
        return $user->can(Permission::MenuManage->value);
    }

    public function delete(User $user, MenuSubCategory $menuSubCategory): bool
    {
        return $user->can(Permission::MenuManage->value);
    }
